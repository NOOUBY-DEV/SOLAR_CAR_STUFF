...
#define USENSOR_1__TRIG_PIN 0
#define USENSOR_2__TRIG_PIN 2
#define USENSOR_3__TRIG_PIN 8
#define USENSOR_4__TRIG_PIN 10
...
unsigned char USENSOR_LIST[] = {USENSOR_1__TRIG_PIN, USENSOR_2__TRIG_PIN, USENSOR_3__TRIG_PIN, USENSOR_4__TRIG_PIN};
char DATA[5];
